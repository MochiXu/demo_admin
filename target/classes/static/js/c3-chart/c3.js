(function (window) {
    ...
    /*
     * Generate chart according to com.mmcc.admin.config
     */
    c3.generate = function (config) {
        ...
        checkConfig('data', 'data is required in com.mmcc.admin.config');
        ...
        */
        ...
        function generateColor(_colors, _pattern) {
            var ids = [],
                colors = _colors,
                pattern = (_pattern !== null) ? _pattern : ['#E67A77', '#79D1CF', '#D9DD81', '#d62728', '#9467bd', '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf']; //same as d3.scale.category10()
